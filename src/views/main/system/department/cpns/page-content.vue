  ...
  <div class="content">
    ...
    <div class="table">
      <el-table :data="pageList" border>
        ...
        <el-table-column align="center" label="部门名称" prop="name" width="130" />
        <el-table-column align="center" label="部门领导" prop="leader" width="120" />
        <el-table-column align="center" label="上级部门" prop="parentId" width="150" />
